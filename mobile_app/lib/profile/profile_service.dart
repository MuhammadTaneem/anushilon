...
updateProfile(data) async {
  ...
  http.put(apiUrl,headers: headers, body: jsonEncode(data),).then((response) async {
  ...
  // await storage.setItem("userGroup", group);
  ...
  //   // pageChange(GroupSelectionScreen.routeName);
  // }
  }).catchError((error) {
