...
// import 'package:mobile_app/dashBoard/dash_board_screen.dart';
// import 'package:mobile_app/profile/profile_page_screen.dart';
// import 'package:mobile_app/questionBank/question_bank_screen.dart';
...
// }
import 'package:flutter/material.dart';
import 'package:mobile_app/screens/dash_board_screen.dart';
...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  final pages = [
    {'label': 'হোম পেইজ', 'icon': const Icon(Icons.home, color: Colors.white,), 'screen': DashBoardScreen()},
    {'label': 'রুটিন', 'icon': const Icon(Icons.event, color: Colors.white,), 'screen': const RoutineScreen()},
